...
def password_reset_request():
	...
	if form.validate_on_submit():
		...
		flash('An email with instructions to reset your password had been sent to you.')
...
def change_email_request():
	...
	if form.validate_on_submit():
		if current_user.verify_password(form.password.data):
			...
			flash('An email withd instructions to confirm your new email address has been sent to you.')
